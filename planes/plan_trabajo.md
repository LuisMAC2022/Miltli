# Plan de trabajo para el primer mes
...
Cada participante realizará en su propio hogar las siguientes actividades:

1. Separar los residuos orgánicos aceptados.
...
Asignar una clave sencilla a cada hogar:
...
## 4. Recursos mínimos por participante
...
## 5. Materiales aceptados durante el piloto
...
* Cáscaras y restos de verduras.
* Café molido y filtros de papel.
* Bolsas de té sin grapas ni plástico.
* Cáscaras de huevo trituradas.
* Flores marchitas.
* Pequeñas cantidades de pasto fresco.

### Materiales secos o cafés

Se utilizarán:

* Hojas secas.
* Cartón café sin cinta ni recubrimientos.
* Papel sin brillo.
* Servilletas de papel sin productos químicos.
* Ramas delgadas cortadas.
* Viruta o aserrín de madera sin tratar.

### Materiales no aceptados

Durante el primer mes no se incorporarán:
...
* Plásticos convencionales o compostables.
* Vidrio o metal.
* Papel plastificado.
* Madera tratada.
* Plantas enfermas.
...
8. ¿Quién continuará con el mismo sistema?
9. ¿Quién necesita modificar o ampliar su compostera?
10. ¿Es conveniente comenzar un segundo lote?
...
# Resultado esperado al finalizar el mes
